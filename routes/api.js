...
router.get('/yta', async(req, res, next) => {
  ...
  fetch(encodeURI(`https://api.justaqul.xyz/ytmp3?url=${url}&apikey=2Md3BTMSxLAs5h5g`))
        .then(response => response.json())
        .then(data => {
...
router.get('/ytv', async(req, res, next) => {
  ...
  fetch(encodeURI(`https://api.justaqul.xyz/ytmp4?url=${url}&quality=360p&apikey=2Md3BTMSxLAs5h5g`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get("/ytplaymp3", async(req, res, next) => {
    ...
    if(listkey.includes(apikey)){
     ...
     fetch(encodeURI(`https://api.zeks.me/api/ytplaymp3?apikey=VanessaCans&q=${query}`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get("/ytplaymp4", async(req, res, next) => {
    ...
    if(listkey.includes(apikey)){
     ...
     fetch(encodeURI(`https://api.zeks.me/api/ytplaymp4?apikey=VanessaCans&q=${query}`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get("/ytplay2", async(req, res, next) => {
    ...
    if(listkey.includes(apikey)){
     ...
     fetch(encodeURI(`https://lolhuman.herokuapp.com/api/ytplay2?apikey=CyzKey&query=${query}`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get("/githubstalk", async(req, res, next) => {
    ...
    if(listkey.includes(apikey)){
     ...
     fetch(encodeURI(`https://leyscoders-api.herokuapp.com/api/github?q=${query}&apikey=CyzChan`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/tiktoknowm', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
     ...
     fetch(encodeURI(`https://api.lolhuman.xyz/api/tiktok?apikey=CyzKey&url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/tiktokwm', async (req, res, next) => {
    var Apikey = req.query.apikey,
        url = req.query.url
	...
	if(listkey.includes(Apikey)){
     ...
     fetch(encodeURI(`https://api.vhtear.com/tiktok_no_wm?link=${url}&apikey=VanessaCans`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/random/quotes', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://api.lolhuman.xyz/api/random/quotes?apikey=CyzKey`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/edukasi/fakta', async (req, res, next) => {
        var Apikey = req.query.apikey
            
	if(!Apikey) return res.json(loghandler.notparam)
	if(listkey.includes(Apikey)){

       fetch(encodeURI(`https://leyscoders-api.herokuapp.com/api/fakta?apikey=CyzKey`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/quotes/dilan', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://lolhuman.herokuapp.com/api/quotes/dilan?apikey=CyzKey`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/random/quotesnime', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://lolhuman.herokuapp.com/api/random/quotesnime?apikey=CyzKey`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/random/quotesimage', async (req, res, next) => {
  ...
  let hasil = 'https://lolhuman.herokuapp.com/api/random/quotesimage?apikey=CyzKey' 
...
router.get('/textpro/neon', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = `https://lolhuman.herokuapp.com/api/textprome/neon?apikey=CyzKey&text=${text}`
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/search/pinterest', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = `https://fdz-app.herokuapp.com/api/pinterest?q=${text}`
  data = await fetch(hasil).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/pinter.jpg', data)
  res.sendFile(__path +'/tmp/pinter.jpg')
  } else {
    res.json(loghandler.invalidKey)
  }
});
...
router.get('/textpro/advanceglow', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = `https://lolhuman.herokuapp.com/api/textprome/advanceglow?apikey=CyzKey&text=${text}`
  data = await fetch(hasil).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/advance.jpg', data)
  res.sendFile(__path +'/tmp/advance.jpg')
  } else {
    res.json(loghandler.invalidKey)
  }
});
...
router.get('/textpro/sandwriting', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = `https://lolhuman.herokuapp.com/api/textprome/sandwriting?apikey=CyzKey&text=${text}`
  data = await fetch(hasil).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/sandwrit.jpg', data)
  res.sendFile(__path +'/tmp/sandwrit.jpg')
  } else {
    res.json(loghandler.invalidKey)
  }
});
...
router.get('/textpro/sandengraved', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = `https://lolhuman.herokuapp.com/api/textprome/sandengraved?apikey=CyzKey&text=${text}`
  data = await fetch(hasil).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/sandegrav.jpg', data)
  res.sendFile(__path +'/tmp/sandegrav.jpg')
  } else {
    res.json(loghandler.invalidKey)
  }
});
...
router.get('/textpro/metaldark', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = `https://lolhuman.herokuapp.com/api/api/textprome/metaldark?apikey=CyzKey&text=${text}`
  data = await fetch(hasil).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/metaldark.jpg', data)
  res.sendFile(__path +'/tmp/metaldark.jpg')
  } else {
    res.json(loghandler.invalidKey)
  }
});
...
router.get('/textpro/holographic', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = `https://lolhuman.herokuapp.com/api/textprome/holographic?apikey=CyzKey&text=${text}`
  data = await fetch(hasil).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/neon.jpg', data)
  res.sendFile(__path +'/tmp/neon.jpg')
  } else {
...
router.get('/textpro/text1917', async(req, res, next) => {
  const text = req.query.text;
  const apikey = req.query.apikey;
  ...
  if(listkey.includes(apikey)) {
  let hasil = `https://lolhuman.herokuapp.com/api/textprome/text1917?apikey=APIKEY&text=${text}`
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/textpro/minion', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = `https://lolhuman.herokuapp.com/api/textprome/minion?apikey=CyzKey&text=${text}`
  data = await fetch(hasil).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/minion.jpg', data)
  res.sendFile(__path +'/tmp/minion.jpg')
  } else {
    res.json(loghandler.invalidKey)
  }
});
...
router.get('/textpro/deluxesilver', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = `https://lolhuman.herokuapp.com/api/textprome/deluxesilver?apikey=CyzKey&text=${text}`
  data = await fetch(hasil).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/deluxesilver.jpg', data)
  res.sendFile(__path +'/tmp/deluxesilver.jpg')
  } else {
    res.json(loghandler.invalidKey)
  }
});

router.get('/textpro/newyearcard', async(req, res, next) => {
  const text = req.query.text;
  const apikey = req.query.apikey;
  ...
  if(listkey.includes(apikey)) {
  let hasil = `https://lolhuman.herokuapp.com/api/textprome/newyearcard?apikey=CyzKey&text=${text}`
  data = await fetch(hasil).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/newyearcard.jpg', data)
  res.sendFile(__path +'/tmp/newyearcard.jpg')
  } else {
    res.json(loghandler.invalidKey)
  }
});
...
router.get('/textpro/jokerlogo', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = `https://lolhuman.herokuapp.com/api/textprome/jokerlogo?apikey=CyzKey&text=${text}`
  data = await fetch(hasil).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/jokerlogo.jpg', data)
  res.sendFile(__path +'/tmp/jokerlogo.jpg')
  } else {
    res.json(loghandler.invalidKey)
  }
});
...
router.get('/random/katabijak', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://lolhuman.herokuapp.com/api/random/katabijak?apikey=CyzKey`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/random/pantun', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://lolhuman.herokuapp.com/api/random/pantun?apikey=CyzKey`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/random/bucin', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://lolhuman.herokuapp.com/api/random/bucin?apikey=CyzKey`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/random/nama', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://lolhuman.herokuapp.com/api/random/nama?apikey=CyzKey`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/quotes/muslim', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://api.lolhuman.xyz/api/quotes/islami?apikey=CyzKey`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/edukasi/wikipedia', async (req, res, next) => {
        var Apikey = req.query.apikey,
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://leyscoders-api.herokuapp.com/api/wiki?kata=${search}&apikey=CyzKey`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/edukasi/simi', async (req, res, next) => {
        var Apikey = req.query.apikey,
            search = req.query.search
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://api.zeks.me/api/simi?apikey=VanessaCans&text=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/igfoto', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = `https://leyscoders-api.herokuapp.com/api/instagram/photo?url=${url}&apikey=CyzKey`
  data = await fetch(hasil).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/igfoto.jpg', data)
  res.sendFile(__path +'/tmp/igfoto.jpg')
  } else {
    res.json(loghandler.invalidKey)
  }
});
...
router.get('/photooxy/flower', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.justaqul.xyz/photooxy/flower?text=${text}&apikey=2Md3BTMSxLAs5h5g`))
    .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
